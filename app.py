...
# Create the vectoriser and classifier
    ...
    if choice == "Home":
        ...
        if not os.path.exists('chat_log.csv'):
            with open('chat_log.csv', 'w', newline = '', encoding = 'utf-8') as csvfile:
                ...
                csv_writer.writerow(['User Input', 'Neurobot Response', 'Timestamp'])
        ...
        if user_input:
            ...
            st.text_area("NeuroBot:", value = response, height = 120, max_chars = None, key = f"neurobot_response_{counter}")
     ...
     # Conversation History Menu
        ...
        st.subheader("Streamlit Neurobot Interface:")
